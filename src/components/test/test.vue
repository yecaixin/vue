...
<template>
  <div id="slider">
    <div class="window" @mouseover="stop" @mouseleave="play">
      ...
      <ul class="direction"  v-if="showDots">
...
<script>
import {strim,DateUtils} from '../../utils/utils';
export default {
  name: 'slider',
  props: {
    initialSpeed: {
  ...
  data () {
    return {
      sliders:[
        {
          img:'http://yecaixin.top/test/img/1.jpg'
        },
        {
          img:'http://yecaixin.top/test/img/2.jpg'
        },
        {
          img:'http://yecaixin.top/test/img/3.jpg'
        },
        {
          img:'http://yecaixin.top/test/img/5.jpg'
        },
        {
          img:'http://yecaixin.top/test/img/6.jpg'
        }
      ],
      currentIndex:1,
      distance:-600,
  ...
  mounted() {
    ...
    var arr = "  hello";
    console.log(arr);
    console.log(strim(arr));

    console.log(DateUtils.dateFormat());
  },
  methods:{
    init() {
      this.play()
